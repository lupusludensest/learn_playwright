...
function formatTestWarning(screen, config, warnings) {
  warnings.sort((a, b) => {
    const aLocationKey = a.location ? `${a.location.file}:${a.location.line}:${a.location.column}` : void 0;
    const bLocationKey = b.location ? `${b.location.file}:${b.location.line}:${b.location.column}` : void 0;
